class Channel < ApplicationRecord
  ...
  def member_count
    # Prefer live association counts so UI badges/popovers don't drift from stale counter caches.
    association(:channel_memberships).loaded? ? channel_memberships.size : channel_memberships.count
  end
